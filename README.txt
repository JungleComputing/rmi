...
Ibis RMI is part of Ibis, an open source Java grid software project of
...
how to compile and run your Ibis RMI application.

The javadoc of Ibis RMI is available in "javadoc/index.html".
...
** Third party libraries included with Ibis RMI **
